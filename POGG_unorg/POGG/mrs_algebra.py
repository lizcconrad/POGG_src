...
def op_non_scopal(functor, argument, slot_label):
    """
    ...
    if len(functor.holes) == 0 or slot_label not in functor.holes:
        raise RuntimeError("Semantic functor has no {} hole".format(slot_label))
